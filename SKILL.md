...
**الإصدار:** 0.1.0 (Chain of Custody · Counter-Hypotheses · Timeline-first · Human Gate · Gap Intelligence · Visual Protocols)  
...
| الإصدار | التغيير |
|---------|---------|
| 0.1.0 | الإصدار الأولي — تكييف كامل من research-brain للتحقيق: Chain of Custody، Counter-Hypotheses، Timeline-first، أوضاع أ/ب/ج/د، طيف أدلة تحقيقي، Visual Protocols |
