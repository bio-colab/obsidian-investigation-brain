# CASE-FICT-LABGAP-018 — Fictional assault — missing lab + contradiction
...
## Brief
Missing-evidence detection + alibi contradiction focus.
...
- `EV-SCENE-001` (physical-evidence, operational): Scene photo log
- `EV-ALIBI-A` (testimonial, operational): Suspect A alibi statement
- `EV-ALIBI-B` (testimonial, operational): Witness places suspect A at scene
